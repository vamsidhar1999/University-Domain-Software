...
public class ADMIN_LOGIN extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon("C:\\Users\\VAMSI\\Desktop\\login-icon-png-27.png")); // NOI18N
...
int flag=1;
        try {
            ...
            while(rs.next())
            {
                if(rs.getString(1).equals(jTextField2.getText())&& rs.getString(2).equals(jPasswordField2.getText()))
                {
                    flag=0;
